...
<div class="video__stuff">
    ...
    <svg id="icon_home_menu_{{ $video->videoid }}" class="icon_menu_points stuff" xmlns="http://www.w3.org/2000/svg" fill="#fff" focusable="false" stroke="#fff" viewBox="0 0 24 24" role="img" aria-hidden="true">
        <g>
